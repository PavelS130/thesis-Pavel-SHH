...
{\centering \includegraphics{chapters/presentacion_files/figure-pdf/cell-2-output-1.png}
...
Micro     0.933  0.067     0.000   0.000
Minor     0.033  0.943     0.024   0.000
Moderate  0.001  0.064     0.905   0.030
Strong    0.002  0.000     0.087   0.911
\end{verbatim}

\begin{figure}[H]

{\centering \includegraphics{chapters/presentacion_files/figure-pdf/cell-2-output-3.png}
...
cuál es una integral de Ito, es adaptado. Asumiendo que
\(\mathbb{E}[|Z_0|^2]<\infty\) y por hipotésis, de la condición (C2),
podemos afirmar que
...
Podemos afirmar que es una martingala. Usando la isometría de Ito,
...
variable \(C_1(t):=\max{\{3t,12\}}\), de aquí \textgreater{}
...
Por hipotésis, los coeficientes \(b\), \(\alpha\) y \(F\) cumplen con la
